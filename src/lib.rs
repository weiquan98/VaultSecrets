...
#[derive(Debug)]
pub struct VaultSecretsProcessor {
    verbose: bool,
    processed_count: usize,
}

impl VaultSecretsProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting VaultSecrets processing");
    
    let mut processor = VaultSecretsProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = VaultSecretsProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = VaultSecretsProcessor::new(false);
